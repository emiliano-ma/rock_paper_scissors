...
const RenderGame = ({
  ...
  return (
    <>
      <Menu size="massive">
        <Menu.Item id="player-name" inverted="true" header>
          Best of luck {playerName}!
        </Menu.Item>
        <Menu.Item id="back" onClick={onClickHandler}>
          Edit Name
        </Menu.Item>
      </Menu>
      ...
      <div className="divs">
        <Menu inverted={true} size="massive" vertical>
          <Menu.Item>
            <Label id="playerScore" color="green">
              {playerScore}
            </Label>
            {playerName} Score
          </Menu.Item>
        ...
        <Menu inverted={true} size="massive" vertical>
          <Menu.Item>
            <Label id="computerScore" color="red">
              {computerScore}
            </Label>
            Computer Score
          </Menu.Item>
      ...
      <div className="choices">
        <span
          ...
          className="emoji"
          id="Rock"
          aria-label="jsx-a11y/accessible-emo"
          role="img"
        >
          ✊
        </span>
